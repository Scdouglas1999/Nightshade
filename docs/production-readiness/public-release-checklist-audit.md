...
| Hardware And Remote Control | 3 | 2 | 1 | 0 |
| Mobile And Migration | 4 | 4 | 0 | 0 |
...
- `line 32` `Release Branch And Packaging`: Windows bundle audit passes for a bundle built from the final release
- `line 52` `Hardware And Remote Control`: Second-device LAN/firewall remote access smoke passes from a physical
- `line 80` `Final Sign-Off`: Public release external evidence validator passes for Linux build,
- `line 84` `Final Sign-Off`: Final ship/no-ship decision records reviewer, date, commit, version,
