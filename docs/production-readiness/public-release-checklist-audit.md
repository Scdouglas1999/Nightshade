...
| Release Branch And Packaging | 4 | 3 | 1 | 0 |
...
- `line 76` `Final Sign-Off`: Public release external evidence validator passes for Linux build,
- `line 80` `Final Sign-Off`: Final ship/no-ship decision records reviewer, date, commit, version,
