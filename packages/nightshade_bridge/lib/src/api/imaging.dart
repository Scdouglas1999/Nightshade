...
// These functions are ignored because they are not marked as `pub`: `apply_auto_white_balance`, `camera_start_exposure_configured_opt`, `camera_start_exposure_opt`, `classify_exposure_failure`, `compute_quality_maps_from_linear_data`, `convert_config`, `convert_result`, `convert_stats`, `defect_apply_flags`, `defect_map_path`, `defect_maps_root`, `display_data_to_rgba`, `format_sexagesimal`, `generate_simulated_image`, `get_autofocus_cancel_token`, `get_unified_image_storage`, `image_data_to_linear_f64`, `mad`, `median`, `parse_combine_method`, `parse_master_kind`, `parse_output_type`, `percentile_sorted`, `percentile`, `sanitize_camera_id`, `set_optional_airmass`, `set_pointing_keywords`, `store_captured_image_atomically`
