...
// These functions are ignored because they are not marked as `pub`: `abort_sim_exposure`, `advance_sim_cooler`, `advance_sim_cover_calibrator`, `advance_sim_guide_pulse`, `advance_sim_slew`, `advance`, `angular_separation_deg`, `apply_offset_delta`, `begin_brightness_ramp`, `begin_sim_exposure`, `begin_sim_slew`, `calibrator_state`, `cancel_sim_slew`, `cover_state`, `drift_step_secs`, `filter_wheel_status_poll_states`, `fraction`, `get_sim_camera`, `get_sim_cover_calibrator`, `get_sim_dome`, `get_sim_filterwheel`, `get_sim_last_exposure`, `get_sim_mount`, `get_sim_safety_monitor`, `get_sim_switch`, `get_sim_weather`, `index_of`, `interpolate_ra`, `is_complete`, `next_sim_frame_seed`, `pier_side_after_slew_to`, `poll_filter_wheel_position`, `quantise`, `reported_brightness`, `require_connected`, `require_connected`, `reset_sim_guide_offset`, `settle`, `sim_calibrator_off`, `sim_calibrator_on`, `sim_camera_state`, `sim_cooler_last_tick`, `sim_cover_halt`, `sim_cover_move`, `sim_cover_status`, `sim_drift_last_tick`, `sim_exposure_elapsed_is_complete`, `sim_exposure_is_complete`, `sim_exposure_phase`, `sim_fault`, `sim_guide_offset_px`, `sim_guide_offset`, `sim_local_sidereal_time`, `sim_park_position`, `sim_pulse_delta`, `sim_slew_duration_secs`, `sim_slew_in_flight`, `sim_slew`, `sim_switch_apply`, `sim_switch_count`, `sim_switch_read`, `sim_switch_value_as_bool`, `sim_switch_write_state`, `sim_switch_write_value`, `take_sim_exposure_for_download`, `value`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `FilterWheelStatusPollState`, `SimDeviceError`, `SimExposurePhase`, `SimExposureRequest`, `SimRamp`, `SimSlew`, `SimSwitchChannel`, `SimSwitchCommand`, `SimSwitchReading`, `SimulatedCoverCalibrator`, `SimulatedSwitch`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_fields_are_eq`, `assert_fields_are_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`
