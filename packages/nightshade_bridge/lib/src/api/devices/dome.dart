...
/// Get dome status
Future<DomeStatus> apiGetDomeStatus({required String deviceId}) => RustLib
    .instance
    .api
    .crateApiDevicesDomeApiGetDomeStatus(deviceId: deviceId);

/// Open dome shutter
Future<void> apiDomeOpenShutter({required String deviceId}) => RustLib
    .instance
    .api
    .crateApiDevicesDomeApiDomeOpenShutter(deviceId: deviceId);

/// Close dome shutter
Future<void> apiDomeCloseShutter({required String deviceId}) => RustLib
    .instance
    .api
...
/// Get dome azimuth
Future<double> apiDomeGetAzimuth({required String deviceId}) => RustLib
    .instance
    .api
    .crateApiDevicesDomeApiDomeGetAzimuth(deviceId: deviceId);

/// Get dome shutter status
Future<int> apiDomeGetShutterStatus({required String deviceId}) => RustLib
    .instance
    .api
    .crateApiDevicesDomeApiDomeGetShutterStatus(deviceId: deviceId);

/// Check if dome is slewing
Future<bool> apiDomeIsSlewing({required String deviceId}) => RustLib
    .instance
    .api
...
Future<void> apiDomeAbortSlew({required String deviceId}) => RustLib
    .instance
    .api
