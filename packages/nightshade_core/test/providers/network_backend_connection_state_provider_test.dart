...
void main() {
  test(
    'networkBackendConnectionStateProvider: emits disconnected when the '
    'active backend is the default DisconnectedBackend',
    () async {
      ...
      // mobile UI side.
      final asyncValue =
          container.read(networkBackendConnectionStateProvider);
