...
void main() {
  ...
  test('cover / calibrator / science-photometry nodes round-trip through the DB',
      () async {
    ...
    final sequence = Sequence.create(
      ...
      nodes: {
        ...
        'calib-off': CalibratorOffNode(
            id: 'calib-off', parentId: 'root', timeoutSecs: 25),
        'close-cover': CloseCoverNode(
            id: 'close-cover', parentId: 'root', timeoutSecs: 75),
      },
    );
