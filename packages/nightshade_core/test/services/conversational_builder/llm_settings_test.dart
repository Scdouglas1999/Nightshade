...
void main() {
  ...
  group('LlmSettingsService', () {
    ...
    test('load returns defaults when nothing persisted', () async {
      ...
      expect(settings.perKind[LlmProviderKind.openAiCompatible]!.baseUrl,
          contains('openai.com'));
      expect(settings.perKind[LlmProviderKind.ollama]!.baseUrl,
    ...
    test('writeApiKey persists into SecretsStore (not app_settings)',
        () async {
