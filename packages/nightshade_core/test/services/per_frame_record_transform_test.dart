...
void main() {
  group('PerFrameRecord transform decode', () {
    test('decodes the row-major 9-element transform + kind from native JSON',
        () {
    ...
    test('toJson omits the transform keys when null, includes them when set',
        () {
    ...
    test('IntegrateSessionResult.fromJson threads the transform through frames',
        () {
