...
mixin _$EquipmentProfile {
  String get id;
  String get name;
  String? get description; // Device identifiers
  String? get cameraId;
  String? get mountId;
  ...
  String? get switchId;
  String? get coverCalibratorId; // Optical setup
  double get focalLength;
  double get aperture;
  double? get focalRatio; // Camera defaults
  int? get defaultGain;
  int? get defaultOffset;
  int get defaultBinX;
  int get defaultBinY;
  double? get defaultCoolingTemp;
  bool get coolOnConnect; // Centering/plate-solve exposure default (seconds)
  double?
      get defaultCenteringExposure; // Filter configuration (JSON-serialized in DB)
  String? get filterNames;
  String? get filterFocusOffsets; // Meridian flip settings overrides (JSON)
  ...
  String? get rotatorName; // Telescope/OTA information
  String? get telescopeName;
  double get telescopeFocalLength;
  double get telescopeAperture; // Profile customization
  String? get profileIcon;
  int? get profileColor;
  int get sortOrder;
  bool get isDefault; // Timestamps
  DateTime? get createdAt;
  DateTime? get updatedAt; // State flags
  ...
  $EquipmentProfileCopyWith<EquipmentProfile> get copyWith =>
      _$EquipmentProfileCopyWithImpl<EquipmentProfile>(
          this as EquipmentProfile, _$identity);
...
abstract mixin class $EquipmentProfileCopyWith<$Res> {
  factory $EquipmentProfileCopyWith(
          EquipmentProfile value, $Res Function(EquipmentProfile) _then) =
      _$EquipmentProfileCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String name,
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      defaultCenteringExposure: freezed == defaultCenteringExposure
          ? _self.defaultCenteringExposure
...
extension EquipmentProfilePatterns on EquipmentProfile {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EquipmentProfile value)? $default, {
    ...
    switch (_that) {
      case _EquipmentProfile() when $default != null:
        return $default(
            ...
            _that.domeId,
            _that.weatherId,
            _that.safetyMonitorId,
            _that.switchId,
            _that.coverCalibratorId,
            _that.focalLength,
            _that.aperture,
            _that.focalRatio,
            _that.defaultGain,
            ...
            _that.defaultBinX,
            _that.defaultBinY,
            _that.defaultCoolingTemp,
            _that.coolOnConnect,
            _that.defaultCenteringExposure,
            _that.filterNames,
            _that.filterFocusOffsets,
            _that.meridianFlipOverrides,
            _that.cameraName,
            _that.mountName,
            _that.focuserName,
            _that.filterWheelName,
            _that.guiderName,
            _that.rotatorName,
            _that.telescopeName,
            _that.telescopeFocalLength,
            _that.telescopeAperture,
            _that.profileIcon,
            _that.profileColor,
            _that.sortOrder,
            _that.isDefault,
...
// Camera pixel size in microns (not in DB, used by bridge)
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EquipmentProfileCopyWith<_EquipmentProfile> get copyWith =>
      __$EquipmentProfileCopyWithImpl<_EquipmentProfile>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EquipmentProfileToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EquipmentProfileCopyWith<$Res>
    implements $EquipmentProfileCopyWith<$Res> {
  factory _$EquipmentProfileCopyWith(
          _EquipmentProfile value, $Res Function(_EquipmentProfile) _then) =
      __$EquipmentProfileCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
