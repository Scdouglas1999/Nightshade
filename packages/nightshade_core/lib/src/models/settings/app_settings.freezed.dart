...
// Protocol settings
 String get indiServerHost; int get indiServerPort; bool get indiAutoConnect; String get alpacaServerHost; int get alpacaServerPort; bool get alpacaAutoDiscover;// Retired: simulation mode is not a shippable runtime state (the bundled
...
// reads it.
 bool get useSimulationMode;// Image capture settings
 ...
 SafetyFailMode get safetyFailMode;// Image grading: live frame Pass/Reject thresholds. Opt-in — disabled by
...
/// are used verbatim.
 String? get imageGradingRejectFolderPath;// Sky-brightness adaptive exposures: global defaults, pushed into the
...
/// globally (matches the Rust `is_enabled_for_filter` semantics).
 ...
 Map<String, double> get adaptiveExposurePerFilterMaxSecs;// Autofocus / dither / weather-safety / recovery knobs an operator tunes
...
/// DB key `recovery_audible_alert_when_entered`.
 bool get recoveryAudibleAlertWhenEntered;// Weather-safety / dawn.
...
/// scales makes every dither settle slowly or time out.
 double get settleThreshold;/// Guider settle timeout in seconds. DB key `settle_timeout`. Generous so
/// a legitimate settle is not aborted early.
 int get settleTimeout;/// Guider settle stabilisation time in seconds — how long the guide error
/// must stay within [settleThreshold] before a settle is declared done.
/// DB key `settle_time`.
 int get settleTime;/// Dither on the RA axis only, leaving Dec fixed. DB key `dither_ra_only`.
 bool get ditherRaOnly;// Plate-solving extra.
...
/// DB key `plate_solver`.
 ...
 bool get blindSolve;/// Sync the mount to the plate-solved position between centering
...
/// DB key `centering_sync_mount`.
 bool get centeringSyncMount;// Site / horizon.
...
/// DB key `dark_library_min_coverage`.
 int get darkLibraryMinCoverage;// Smart Night defaults — the one-click "plan tonight" builder reads these
...
/// DB key `smart_night_target_snr`.
 double get smartNightTargetSnr;// Defaults from here down mirror AppSettingsState's constructor defaults,
...
/// AF method. DB `af_method`.
 ...
 double get afRSquaredThreshold;/// How far above the reference HFR the frames may sit, as a multiple, and
...
/// disables the tolerance, making every failure unrecoverable.
 double get afFailureHfrToleranceRatio;/// What to do when a failed autofocus leaves focus outside the tolerance.
...
/// deserializes, so they are not free text.
 String get afFailureAction;/// AF focuser settle time (ms). DB `af_focuser_settle_time_ms`.
 ...
 int get afBacklashIn;/// What to do when a connected mount's site/time disagrees with this
/// computer's. DB `mount_site_sync_mode`.
 String get mountSiteSyncMode;/// AF backlash-out steps. DB `af_backlash_out`.
...
/// Astrometry.net solver path. DB `astrometry_path`.
 ...
 bool get useSystemTime;// Sequencer output path default.
/// User-facing default output directory for saved sequence files. DB
/// key `sequences_path`.
 String get sequencesPath;// Smart Night target auto-select (the rest of the smart_night.* group
// is already remoted).
/// Auto-select the top-N targets when building a Smart Night plan. DB
/// key `smart_night.auto_select`.
 bool get smartNightAutoSelect;/// How many targets to auto-select when [smartNightAutoSelect] is true.
/// DB key `smart_night.auto_select_count`.
 int get smartNightAutoSelectCount;// Adaptive sky-conditions target-swap scheduler-SEED defaults. These
...
/// `adaptive_swap.enabled_by_default`.
 bool get adaptiveSwapEnabledByDefault;/// Default conditions-score floor (0..=100) seeded into a new scheduler.
/// DB key `adaptive_swap.default_threshold`.
 double get adaptiveSwapDefaultThreshold;/// Default seconds between consecutive swaps seeded into a new scheduler.
/// DB key `adaptive_swap.default_hysteresis_secs`.
 double get adaptiveSwapDefaultHysteresisSecs;/// Per-axis composer weights for the live ConditionsScore. Keys:
/// `transparency` / `seeing` / `cloud` / `wind`. DB key
/// `adaptive_swap.score_weights` (a JSON object).
 Map<String, double> get conditionsScoreWeights;
...
as int,settleTime: null == settleTime ? _self.settleTime : settleTime // ignore: cast_nullable_to_non_nullable
as int,ditherRaOnly: null == ditherRaOnly ? _self.ditherRaOnly : ditherRaOnly // ignore: cast_nullable_to_non_nullable
as bool,plateSolver: null == plateSolver ? _self.plateSolver : plateSolver // ignore: cast_nullable_to_non_nullable
as String,blindSolve: null == blindSolve ? _self.blindSolve : blindSolve // ignore: cast_nullable_to_non_nullable
as bool,centeringSyncMount: null == centeringSyncMount ? _self.centeringSyncMount : centeringSyncMount // ignore: cast_nullable_to_non_nullable
...
as double,defaultGain: null == defaultGain ? _self.defaultGain : defaultGain // ignore: cast_nullable_to_non_nullable
...
as double,afFailureHfrToleranceRatio: null == afFailureHfrToleranceRatio ? _self.afFailureHfrToleranceRatio : afFailureHfrToleranceRatio // ignore: cast_nullable_to_non_nullable
as double,afFailureAction: null == afFailureAction ? _self.afFailureAction : afFailureAction // ignore: cast_nullable_to_non_nullable
as String,afFocuserSettleTimeMs: null == afFocuserSettleTimeMs ? _self.afFocuserSettleTimeMs : afFocuserSettleTimeMs // ignore: cast_nullable_to_non_nullable
...
as int,mountSiteSyncMode: null == mountSiteSyncMode ? _self.mountSiteSyncMode : mountSiteSyncMode // ignore: cast_nullable_to_non_nullable
as String,afBacklashOut: null == afBacklashOut ? _self.afBacklashOut : afBacklashOut // ignore: cast_nullable_to_non_nullable
...
as bool,sequencesPath: null == sequencesPath ? _self.sequencesPath : sequencesPath // ignore: cast_nullable_to_non_nullable
as String,smartNightAutoSelect: null == smartNightAutoSelect ? _self.smartNightAutoSelect : smartNightAutoSelect // ignore: cast_nullable_to_non_nullable
as bool,smartNightAutoSelectCount: null == smartNightAutoSelectCount ? _self.smartNightAutoSelectCount : smartNightAutoSelectCount // ignore: cast_nullable_to_non_nullable
as int,adaptiveSwapEnabledByDefault: null == adaptiveSwapEnabledByDefault ? _self.adaptiveSwapEnabledByDefault : adaptiveSwapEnabledByDefault // ignore: cast_nullable_to_non_nullable
as bool,adaptiveSwapDefaultThreshold: null == adaptiveSwapDefaultThreshold ? _self.adaptiveSwapDefaultThreshold : adaptiveSwapDefaultThreshold // ignore: cast_nullable_to_non_nullable
as double,adaptiveSwapDefaultHysteresisSecs: null == adaptiveSwapDefaultHysteresisSecs ? _self.adaptiveSwapDefaultHysteresisSecs : adaptiveSwapDefaultHysteresisSecs // ignore: cast_nullable_to_non_nullable
as double,conditionsScoreWeights: null == conditionsScoreWeights ? _self.conditionsScoreWeights : conditionsScoreWeights // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ObserverLocation? location,  String theme,  String language,  bool autoConnect,  double latitude,  double longitude,  double elevation,  String fileNamingPattern,  int meridianFlipMinutes,  int autoFocusEveryMinutes,  int ditherEveryFrames,  int plateSolveTimeout,  double plateSolveSearchRadius,  String discordWebhook,  String pushoverKey,  String pushoverUser,  String astapPath,  bool autoDiscoverOnLaunch,  String accentColor,  String fontSize,  String uiScale,  String indiServerHost,  int indiServerPort,  bool indiAutoConnect,  String alpacaServerHost,  int alpacaServerPort,  bool alpacaAutoDiscover,  bool useSimulationMode,  String imageOutputPath,  String observer,  String telescope,  String instrument,  bool updateCheckEnabled,  String updateServerUrl,  String updateChannel,  int updateCheckIntervalHours,  String skippedUpdateVersion,  SafetyFailMode safetyFailMode,  bool enableImageGrading,  double? imageGradingHfrThresholdPx,  double? imageGradingHfrBaselinePercent,  double? imageGradingEccentricityThreshold,  int? imageGradingStarCountMin,  int imageGradingMaxConsecutiveRejects,  String? imageGradingRejectFolderPath,  bool adaptiveExposureEnabled,  double adaptiveExposureTargetSnr,  double adaptiveExposureReferenceMag,  double adaptiveExposureMinSecs,  double adaptiveExposureMaxSecs,  Map<String, bool> adaptiveExposurePerFilterEnabled,  Map<String, double> adaptiveExposurePerFilterMinSecs,  Map<String, double> adaptiveExposurePerFilterMaxSecs,  bool parkOnUnsafeWeather,  bool autoFocusOnFilterChange,  bool afDisableGuidingDuringAf,  bool ditherEnabled,  String ditherScale,  double recoveryDefaultRetryIntervalMins,  double recoveryDefaultMaxDurationMins,  bool recoveryStopTrackingDuringRecovery,  bool recoveryAbortOnMeridian,  bool recoveryAudibleAlertWhenEntered,  bool parkBeforeDawn,  bool enableMeridianFlip,  bool tempCompensation,  double tempCoefficient,  int backlashCompensation,  double settleThreshold,  int settleTimeout,  int settleTime,  bool ditherRaOnly,  String plateSolver,  bool blindSolve,  bool centeringSyncMount,  int bortleClass,  double effectiveHorizonDeg,  String preflightStrictness,  int polarAlignmentMaxAgeDays,  double opticalTrainDriftThreshold,  int darkLibraryMinCoverage,  double? smartNightMaxSessionHours,  int smartNightDefaultAfCadenceFrames,  int smartNightDefaultIntegrationBudgetMinsPerTarget,  bool smartNightIncludeFlatsAtEnd,  bool smartNightUseSchedulerForMultiTarget,  int smartNightSchedulerTargetThreshold,  String smartNightDefaultStrategy,  int smartNightPolarAlignmentStaleAfterDays,  double smartNightSubExposureFloorSecs,  double smartNightSubExposureCeilingSecs,  double smartNightTargetSnr,  int defaultGain,  int defaultOffset,  bool webServerEnabled,  int webServerPort,  String phd2Path,  String phd2Host,  int phd2Port,  bool notificationsEnabled,  bool notifyOnSequenceComplete,  bool notifyOnError,  bool notifyOnMeridianFlip,  bool soundEnabled,  bool audibleAlertsOnCritical,  String criticalAlertSound,  bool pushCriticalAlerts,  bool smartNightAutoPromptEnabled,  bool promptForNotesAfterRun,  bool sessionHandoffAutoPrompt,  bool campaignRollupSurfaceTargetsTab,  String campaignRollupGroupingMode,  String afMethod,  String afCurveFitting,  int afStepSize,  double afExposureTime,  int afInitialOffsetSteps,  int afNumberOfAttempts,  int afUseBrightestNStars,  double afOuterCropRatio,  double afInnerCropRatio,  int afBinning,  double afRSquaredThreshold,  double afFailureHfrToleranceRatio,  String afFailureAction,  int afFocuserSettleTimeMs,  int afExposuresPerPoint,  String afBacklashCompMethod,  int afBacklashIn,  String mountSiteSyncMode,  int afBacklashOut,  String afAutofocusFilterName,  String afFilterSettingsJson,  bool useFilterFocusOffsets,  String astrometryPath,  String observerName,  String imageFormat,  String bitDepth,  String timezone,  bool useSystemTime,  String sequencesPath,  bool smartNightAutoSelect,  int smartNightAutoSelectCount,  bool adaptiveSwapEnabledByDefault,  double adaptiveSwapDefaultThreshold,  double adaptiveSwapDefaultHysteresisSecs,  Map<String, double> conditionsScoreWeights)  $default,) {final _that = this;
switch (_that) {
case _AppSettings():
return $default(_that.location,_that.theme,_that.language,_that.autoConnect,_that.latitude,_that.longitude,_that.elevation,_that.fileNamingPattern,_that.meridianFlipMinutes,_that.autoFocusEveryMinutes,_that.ditherEveryFrames,_that.plateSolveTimeout,_that.plateSolveSearchRadius,_that.discordWebhook,_that.pushoverKey,_that.pushoverUser,_that.astapPath,_that.autoDiscoverOnLaunch,_that.accentColor,_that.fontSize,_that.uiScale,_that.indiServerHost,_that.indiServerPort,_that.indiAutoConnect,_that.alpacaServerHost,_that.alpacaServerPort,_that.alpacaAutoDiscover,_that.useSimulationMode,_that.imageOutputPath,_that.observer,_that.telescope,_that.instrument,_that.updateCheckEnabled,_that.updateServerUrl,_that.updateChannel,_that.updateCheckIntervalHours,_that.skippedUpdateVersion,_that.safetyFailMode,_that.enableImageGrading,_that.imageGradingHfrThresholdPx,_that.imageGradingHfrBaselinePercent,_that.imageGradingEccentricityThreshold,_that.imageGradingStarCountMin,_that.imageGradingMaxConsecutiveRejects,_that.imageGradingRejectFolderPath,_that.adaptiveExposureEnabled,_that.adaptiveExposureTargetSnr,_that.adaptiveExposureReferenceMag,_that.adaptiveExposureMinSecs,_that.adaptiveExposureMaxSecs,_that.adaptiveExposurePerFilterEnabled,_that.adaptiveExposurePerFilterMinSecs,_that.adaptiveExposurePerFilterMaxSecs,_that.parkOnUnsafeWeather,_that.autoFocusOnFilterChange,_that.afDisableGuidingDuringAf,_that.ditherEnabled,_that.ditherScale,_that.recoveryDefaultRetryIntervalMins,_that.recoveryDefaultMaxDurationMins,_that.recoveryStopTrackingDuringRecovery,_that.recoveryAbortOnMeridian,_that.recoveryAudibleAlertWhenEntered,_that.parkBeforeDawn,_that.enableMeridianFlip,_that.tempCompensation,_that.tempCoefficient,_that.backlashCompensation,_that.settleThreshold,_that.settleTimeout,_that.settleTime,_that.ditherRaOnly,_that.plateSolver,_that.blindSolve,_that.centeringSyncMount,_that.bortleClass,_that.effectiveHorizonDeg,_that.preflightStrictness,_that.polarAlignmentMaxAgeDays,_that.opticalTrainDriftThreshold,_that.darkLibraryMinCoverage,_that.smartNightMaxSessionHours,_that.smartNightDefaultAfCadenceFrames,_that.smartNightDefaultIntegrationBudgetMinsPerTarget,_that.smartNightIncludeFlatsAtEnd,_that.smartNightUseSchedulerForMultiTarget,_that.smartNightSchedulerTargetThreshold,_that.smartNightDefaultStrategy,_that.smartNightPolarAlignmentStaleAfterDays,_that.smartNightSubExposureFloorSecs,_that.smartNightSubExposureCeilingSecs,_that.smartNightTargetSnr,_that.defaultGain,_that.defaultOffset,_that.webServerEnabled,_that.webServerPort,_that.phd2Path,_that.phd2Host,_that.phd2Port,_that.notificationsEnabled,_that.notifyOnSequenceComplete,_that.notifyOnError,_that.notifyOnMeridianFlip,_that.soundEnabled,_that.audibleAlertsOnCritical,_that.criticalAlertSound,_that.pushCriticalAlerts,_that.smartNightAutoPromptEnabled,_that.promptForNotesAfterRun,_that.sessionHandoffAutoPrompt,_that.campaignRollupSurfaceTargetsTab,_that.campaignRollupGroupingMode,_that.afMethod,_that.afCurveFitting,_that.afStepSize,_that.afExposureTime,_that.afInitialOffsetSteps,_that.afNumberOfAttempts,_that.afUseBrightestNStars,_that.afOuterCropRatio,_that.afInnerCropRatio,_that.afBinning,_that.afRSquaredThreshold,_that.afFailureHfrToleranceRatio,_that.afFailureAction,_that.afFocuserSettleTimeMs,_that.afExposuresPerPoint,_that.afBacklashCompMethod,_that.afBacklashIn,_that.mountSiteSyncMode,_that.afBacklashOut,_that.afAutofocusFilterName,_that.afFilterSettingsJson,_that.useFilterFocusOffsets,_that.astrometryPath,_that.observerName,_that.imageFormat,_that.bitDepth,_that.timezone,_that.useSystemTime,_that.sequencesPath,_that.smartNightAutoSelect,_that.smartNightAutoSelectCount,_that.adaptiveSwapEnabledByDefault,_that.adaptiveSwapDefaultThreshold,_that.adaptiveSwapDefaultHysteresisSecs,_that.conditionsScoreWeights);case _:
  throw StateError('Unexpected subclass');
...
/// must stay within [settleThreshold] before a settle is declared done.
/// DB key `settle_time`.
@override@JsonKey() final  int settleTime;
/// Dither on the RA axis only, leaving Dec fixed. DB key `dither_ra_only`.
@override@JsonKey() final  bool ditherRaOnly;
// Plate-solving extra.
/// Selected plate solver ('ASTAP', 'Astrometry.net', 'PlateSolve2').
/// DB key `plate_solver`.
...
/// produced the mis-pointed frame, so centering cannot converge.
/// DB key `centering_sync_mount`.
@override@JsonKey() final  bool centeringSyncMount;
// Site / horizon.
/// Bortle dark-sky class (1-9). DB key `bortle_class`.
...
/// whose good HFR is 2.5 keeps imaging at 3.8 and stops at 10. Zero
/// disables the tolerance, making every failure unrecoverable.
@override@JsonKey() final  double afFailureHfrToleranceRatio;
/// What to do when a failed autofocus leaves focus outside the tolerance.
/// DB `af_failure_action`. One of `AbortAndPark` or `PauseAndAlert` —
/// these are the wire values the native `AutofocusFailureAction` enum
/// deserializes, so they are not free text.
@override@JsonKey() final  String afFailureAction;
...
/// computer's. DB `mount_site_sync_mode`.
@override@JsonKey() final  String mountSiteSyncMode;
...
/// User-facing default output directory for saved sequence files. DB
/// key `sequences_path`.
@override@JsonKey() final  String sequencesPath;
// Smart Night target auto-select (the rest of the smart_night.* group
// is already remoted).
/// Auto-select the top-N targets when building a Smart Night plan. DB
/// key `smart_night.auto_select`.
@override@JsonKey() final  bool smartNightAutoSelect;
/// How many targets to auto-select when [smartNightAutoSelect] is true.
/// DB key `smart_night.auto_select_count`.
@override@JsonKey() final  int smartNightAutoSelectCount;
...
/// New schedulers ship with adaptive swap enabled by default. DB key
/// `adaptive_swap.enabled_by_default`.
@override@JsonKey() final  bool adaptiveSwapEnabledByDefault;
/// Default conditions-score floor (0..=100) seeded into a new scheduler.
/// DB key `adaptive_swap.default_threshold`.
@override@JsonKey() final  double adaptiveSwapDefaultThreshold;
/// Default seconds between consecutive swaps seeded into a new scheduler.
/// DB key `adaptive_swap.default_hysteresis_secs`.
@override@JsonKey() final  double adaptiveSwapDefaultHysteresisSecs;
/// Per-axis composer weights for the live ConditionsScore. Keys:
/// `transparency` / `seeing` / `cloud` / `wind`. DB key
/// `adaptive_swap.score_weights` (a JSON object).
 final  Map<String, double> _conditionsScoreWeights;
/// Per-axis composer weights for the live ConditionsScore. Keys:
/// `transparency` / `seeing` / `cloud` / `wind`. DB key
/// `adaptive_swap.score_weights` (a JSON object).
@override@JsonKey() Map<String, double> get conditionsScoreWeights {
  if (_conditionsScoreWeights is EqualUnmodifiableMapView) return _conditionsScoreWeights;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_conditionsScoreWeights);
}
...
as bool,adaptiveSwapDefaultThreshold: null == adaptiveSwapDefaultThreshold ? _self.adaptiveSwapDefaultThreshold : adaptiveSwapDefaultThreshold // ignore: cast_nullable_to_non_nullable
as double,adaptiveSwapDefaultHysteresisSecs: null == adaptiveSwapDefaultHysteresisSecs ? _self.adaptiveSwapDefaultHysteresisSecs : adaptiveSwapDefaultHysteresisSecs // ignore: cast_nullable_to_non_nullable
as double,conditionsScoreWeights: null == conditionsScoreWeights ? _self._conditionsScoreWeights : conditionsScoreWeights // ignore: cast_nullable_to_non_nullable
as Map<String, double>,
  ));
}
