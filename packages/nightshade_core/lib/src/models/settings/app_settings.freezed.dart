...
mixin _$ObserverLocation {
  ...
  $ObserverLocationCopyWith<ObserverLocation> get copyWith =>
      _$ObserverLocationCopyWithImpl<ObserverLocation>(
          this as ObserverLocation, _$identity);
...
abstract mixin class $ObserverLocationCopyWith<$Res> {
  factory $ObserverLocationCopyWith(
          ObserverLocation value, $Res Function(ObserverLocation) _then) =
      _$ObserverLocationCopyWithImpl;
  @useResult
...
extension ObserverLocationPatterns on ObserverLocation {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ObserverLocation value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(double latitude, double longitude, double elevation)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ObserverLocation() when $default != null:
        return $default(_that.latitude, _that.longitude, _that.elevation);
      case _:
        return orElse();
    }
  }
...
class _ObserverLocation implements ObserverLocation {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ObserverLocationCopyWith<_ObserverLocation> get copyWith =>
      __$ObserverLocationCopyWithImpl<_ObserverLocation>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ObserverLocationToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ObserverLocationCopyWith<$Res>
    implements $ObserverLocationCopyWith<$Res> {
  factory _$ObserverLocationCopyWith(
          _ObserverLocation value, $Res Function(_ObserverLocation) _then) =
      __$ObserverLocationCopyWithImpl;
  @override
  @useResult
  $Res call({double latitude, double longitude, double elevation});
}
...
mixin _$AppSettings {
  ...
  String get language;
  bool
      get autoConnect; // Additional fields for compatibility with provider AppSettings
  double get latitude;
  double get longitude;
  double get elevation;
  ...
  String get fontSize;
  String
      get uiScale; // Auto, Small (0.8x), Normal (1.0x), Large (1.2x), Extra Large (1.4x)
// Protocol settings
  ...
  bool get alpacaAutoDiscover; // Sequencer execution settings
...
// -------------------------------------------------------------------
  ...
  /// are used verbatim.
  String?
      get imageGradingRejectFolderPath; // -------------------------------------------------------------------
...
// -------------------------------------------------------------------
  ...
  Map<String, double>
      get adaptiveExposurePerFilterMaxSecs; // -------------------------------------------------------------------
...
// -------------------------------------------------------------------
  ...
  bool
      get recoveryAudibleAlertWhenEntered; // -------------------------------------------------------------------
...
// Weather-safety / dawn.
  ...
  bool
      get enableMeridianFlip; // Focuser temperature compensation + backlash (calibration).
  ...
  double
      get effectiveHorizonDeg; // Pre-flight checklist strictness + freshness gates.
...
// Equipment defaults (camera).
  ...
  bool
      get useFilterFocusOffsets; // Misc imaging / FITS / plate-solve config relevant to an unattended night.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.adaptiveExposurePerFilterEnabled, adaptiveExposurePerFilterEnabled) &&
            const DeepCollectionEquality().equals(other.adaptiveExposurePerFilterMinSecs, adaptiveExposurePerFilterMinSecs) &&
            const DeepCollectionEquality().equals(other.adaptiveExposurePerFilterMaxSecs, adaptiveExposurePerFilterMaxSecs) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(adaptiveExposurePerFilterEnabled),
        const DeepCollectionEquality().hash(adaptiveExposurePerFilterMinSecs),
        const DeepCollectionEquality().hash(adaptiveExposurePerFilterMaxSecs),
        parkOnUnsafeWeather,
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      adaptiveExposurePerFilterEnabled: null == adaptiveExposurePerFilterEnabled
          ? _self.adaptiveExposurePerFilterEnabled
      ...
      adaptiveExposurePerFilterMinSecs: null == adaptiveExposurePerFilterMinSecs
          ? _self.adaptiveExposurePerFilterMinSecs
      ...
      recoveryDefaultRetryIntervalMins: null == recoveryDefaultRetryIntervalMins
          ? _self.recoveryDefaultRetryIntervalMins
      ...
      smartNightDefaultAfCadenceFrames: null == smartNightDefaultAfCadenceFrames
          ? _self.smartNightDefaultAfCadenceFrames
      ...
      smartNightDefaultIntegrationBudgetMinsPerTarget: null ==
              smartNightDefaultIntegrationBudgetMinsPerTarget
          ? _self.smartNightDefaultIntegrationBudgetMinsPerTarget
      ...
      smartNightSubExposureFloorSecs: null == smartNightSubExposureFloorSecs
          ? _self.smartNightSubExposureFloorSecs
      ...
      notifyOnSequenceComplete: null == notifyOnSequenceComplete
          ? _self.notifyOnSequenceComplete
      ...
      campaignRollupSurfaceTargetsTab: null == campaignRollupSurfaceTargetsTab
          ? _self.campaignRollupSurfaceTargetsTab
      ...
      campaignRollupGroupingMode: null == campaignRollupGroupingMode
          ? _self.campaignRollupGroupingMode
    ...
    switch (_that) {
      case _AppSettings() when $default != null:
        return $default(
            ...
            _that.longitude,
            _that.elevation,
            _that.fileNamingPattern,
            _that.meridianFlipMinutes,
            _that.autoFocusEveryMinutes,
            _that.ditherEveryFrames,
            _that.plateSolveTimeout,
            _that.plateSolveSearchRadius,
            _that.discordWebhook,
            _that.pushoverKey,
            _that.pushoverUser,
            _that.astapPath,
            _that.autoDiscoverOnLaunch,
            _that.accentColor,
            _that.fontSize,
            _that.uiScale,
            _that.indiServerHost,
            _that.indiServerPort,
            _that.indiAutoConnect,
            _that.alpacaServerHost,
            _that.alpacaServerPort,
            _that.alpacaAutoDiscover,
            _that.useNativeExecution,
            _that.useSimulationMode,
            _that.imageOutputPath,
            _that.observer,
            _that.telescope,
            _that.instrument,
            _that.updateCheckEnabled,
            _that.updateServerUrl,
            _that.updateChannel,
            _that.updateCheckIntervalHours,
            _that.skippedUpdateVersion,
            _that.safetyFailMode,
            _that.enableImageGrading,
            _that.imageGradingHfrThresholdPx,
            _that.imageGradingHfrBaselinePercent,
            _that.imageGradingEccentricityThreshold,
            _that.imageGradingStarCountMin,
            _that.imageGradingMaxConsecutiveRejects,
            _that.imageGradingRejectFolderPath,
            _that.adaptiveExposureEnabled,
            _that.adaptiveExposureTargetSnr,
            _that.adaptiveExposureReferenceMag,
            _that.adaptiveExposureMinSecs,
            _that.adaptiveExposureMaxSecs,
            _that.adaptiveExposurePerFilterEnabled,
            _that.adaptiveExposurePerFilterMinSecs,
            _that.adaptiveExposurePerFilterMaxSecs,
            _that.parkOnUnsafeWeather,
            _that.autoFocusOnFilterChange,
            _that.afDisableGuidingDuringAf,
            _that.ditherEnabled,
            _that.ditherScale,
            _that.recoveryDefaultRetryIntervalMins,
            _that.recoveryDefaultMaxDurationMins,
            _that.recoveryStopTrackingDuringRecovery,
            _that.recoveryAbortOnMeridian,
            _that.recoveryAudibleAlertWhenEntered,
            _that.parkBeforeDawn,
            _that.enableMeridianFlip,
            _that.tempCompensation,
            _that.tempCoefficient,
            _that.backlashCompensation,
            _that.settleThreshold,
            _that.settleTimeout,
            _that.plateSolver,
            _that.blindSolve,
            _that.bortleClass,
            _that.effectiveHorizonDeg,
            _that.preflightStrictness,
            _that.polarAlignmentMaxAgeDays,
            _that.opticalTrainDriftThreshold,
            _that.darkLibraryMinCoverage,
            _that.smartNightMaxSessionHours,
            _that.smartNightDefaultAfCadenceFrames,
            _that.smartNightDefaultIntegrationBudgetMinsPerTarget,
            _that.smartNightIncludeFlatsAtEnd,
            _that.smartNightUseSchedulerForMultiTarget,
            _that.smartNightSchedulerTargetThreshold,
            _that.smartNightDefaultStrategy,
            _that.smartNightPolarAlignmentStaleAfterDays,
            _that.smartNightSubExposureFloorSecs,
            _that.smartNightSubExposureCeilingSecs,
            _that.smartNightTargetSnr,
            _that.coolingBehavior,
            _that.defaultGain,
            _that.defaultOffset,
            _that.webServerEnabled,
            _that.webServerPort,
            _that.phd2Path,
            _that.phd2Host,
            _that.phd2Port,
            _that.notificationsEnabled,
            _that.notifyOnSequenceComplete,
            _that.notifyOnError,
            _that.notifyOnMeridianFlip,
            _that.soundEnabled,
            _that.audibleAlertsOnCritical,
            _that.criticalAlertSound,
            _that.pushCriticalAlerts,
            _that.smartNightAutoPromptEnabled,
            _that.promptForNotesAfterRun,
            _that.sessionHandoffAutoPrompt,
            _that.campaignRollupSurfaceTargetsTab,
            _that.campaignRollupGroupingMode,
            _that.afMethod,
            _that.afCurveFitting,
            _that.afStepSize,
            _that.afExposureTime,
            _that.afInitialOffsetSteps,
            _that.afNumberOfAttempts,
            _that.afUseBrightestNStars,
            _that.afOuterCropRatio,
            _that.afInnerCropRatio,
            _that.afBinning,
            _that.afRSquaredThreshold,
            _that.afFocuserSettleTimeMs,
            _that.afExposuresPerPoint,
            _that.afBacklashCompMethod,
            _that.afBacklashIn,
            _that.afBacklashOut,
            _that.afAutofocusFilterName,
            _that.afFilterSettingsJson,
            _that.useFilterFocusOffsets,
            _that.astrometryPath,
            _that.observerName,
            _that.imageFormat,
            _that.bitDepth,
            _that.timezone,
    ...
    return _then(_AppSettings(
      ...
      adaptiveExposureMaxSecs: null == adaptiveExposureMaxSecs
          ...
          : adaptiveExposureMaxSecs // ignore: cast_nullable_to_non_nullable
              as double,
      adaptiveExposurePerFilterEnabled: null == adaptiveExposurePerFilterEnabled
          ? _self._adaptiveExposurePerFilterEnabled
          : adaptiveExposurePerFilterEnabled // ignore: cast_nullable_to_non_nullable
              as Map<String, bool>,
      adaptiveExposurePerFilterMinSecs: null == adaptiveExposurePerFilterMinSecs
          ? _self._adaptiveExposurePerFilterMinSecs
          : adaptiveExposurePerFilterMinSecs // ignore: cast_nullable_to_non_nullable
              as Map<String, double>,
      adaptiveExposurePerFilterMaxSecs: null == adaptiveExposurePerFilterMaxSecs
          ? _self._adaptiveExposurePerFilterMaxSecs
          : adaptiveExposurePerFilterMaxSecs // ignore: cast_nullable_to_non_nullable
              as Map<String, double>,
      parkOnUnsafeWeather: null == parkOnUnsafeWeather
          ? _self.parkOnUnsafeWeather
