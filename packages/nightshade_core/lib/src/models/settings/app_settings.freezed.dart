...
/// scales makes every dither settle slowly or time out.
 double get settleThreshold;/// Guider settle timeout in seconds. DB key `settle_timeout`. Roomier than
