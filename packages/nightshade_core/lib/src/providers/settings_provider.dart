...
// one UI / domain section. This keeps each section file ≤ ~250 LOC and lets
...
// `settings_sections/` and add the setter + state field + JSON / persistence
// wiring there. The state class (`AppSettingsState`) and DAO mapping stay
// in this main file because they enumerate every field once; splitting them
// further would just push the conflict to a different file.
// ============================================================================
...
class AppSettingsNotifier extends AsyncNotifier<AppSettingsState> {
  ...
  // _applySettingsMap), remote-sync glue, and parse utilities that every
  // section reuses.
}
