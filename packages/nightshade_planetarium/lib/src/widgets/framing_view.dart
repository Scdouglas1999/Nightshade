...
class _FramingViewState extends ConsumerState<FramingView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        // Background with survey placeholder
        _buildBackground(),
            ...
            child: GestureDetector(
              ...
              onPanUpdate: (details) {
                if (_isRotatingFOV) {
                  ...
                  ref.read(equipmentFOVProvider.notifier).setRotation(newRotation);
        ...
        Positioned(
          ...
          child: _ZoomControls(
            zoom: _zoom,
            onZoomIn: () => setState(() => _zoom = (_zoom * 1.5).clamp(0.25, 4.0)),
            onZoomOut: () => setState(() => _zoom = (_zoom / 1.5).clamp(0.25, 4.0)),
            onReset: () => setState(() {
              _zoom = 1.0;
              _pan = Offset.zero;
            }),
