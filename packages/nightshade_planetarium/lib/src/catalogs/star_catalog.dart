...
class HygStarCatalog extends Catalog<Star> {
  ...
  static final List<Star> _fallbackBrightStars = [
    ...
    const Star(
      id: 'HIP32349',
      name: 'Sirius',
      coordinates: CelestialCoordinate(ra: 101.286, dec: -16.7161),
      magnitude: -1.46,
      spectralType: 'A1V',
      constellation: 'CMA',
    ),
    const Star(
      id: 'HIP30438',
      name: 'Canopus',
      coordinates: CelestialCoordinate(ra: 95.985, dec: -52.6957),
      magnitude: -0.72,
      spectralType: 'F0II',
      constellation: 'CAR',
    ),
    const Star(
      ...
      coordinates: CelestialCoordinate(ra: 219.899, dec: -60.8354),
      magnitude: -0.29,
      spectralType: 'G2V',
      constellation: 'CEN',
    ),
    const Star(
      id: 'HIP69673',
      name: 'Arcturus',
      coordinates: CelestialCoordinate(ra: 213.918, dec: 19.1825),
      magnitude: -0.05,
    ...
    const Star(
      id: 'HIP91262',
      name: 'Vega',
      coordinates: CelestialCoordinate(ra: 279.234, dec: 38.7837),
      magnitude: 0.03,
      spectralType: 'A0V',
      constellation: 'LYR',
    ),
    const Star(
      id: 'HIP24608',
      name: 'Capella',
      coordinates: CelestialCoordinate(ra: 79.176, dec: 45.9980),
      magnitude: 0.08,
      spectralType: 'G8III',
      constellation: 'AUR',
    ),
    const Star(
      id: 'HIP24436',
      name: 'Rigel',
      coordinates: CelestialCoordinate(ra: 78.633, dec: -8.2017),
      magnitude: 0.13,
      spectralType: 'B8Ia',
      constellation: 'ORI',
    ),
    const Star(
      id: 'HIP37279',
      name: 'Procyon',
      coordinates: CelestialCoordinate(ra: 114.828, dec: 5.2250),
      magnitude: 0.34,
      spectralType: 'F5IV',
      constellation: 'CMI',
    ),
    const Star(
      id: 'HIP27989',
      name: 'Betelgeuse',
      coordinates: CelestialCoordinate(ra: 88.793, dec: 7.4070),
      magnitude: 0.42,
      spectralType: 'M2Ib',
      constellation: 'ORI',
    ),
    const Star(
      id: 'HIP7588',
      name: 'Achernar',
      coordinates: CelestialCoordinate(ra: 24.428, dec: -57.2367),
      magnitude: 0.46,
      spectralType: 'B3V',
      constellation: 'ERI',
    ),
    const Star(
      id: 'HIP80763',
      name: 'Hadar',
      coordinates: CelestialCoordinate(ra: 210.956, dec: -60.3730),
      magnitude: 0.60,
      spectralType: 'B1III',
      constellation: 'CEN',
    ),
    const Star(
      id: 'HIP97649',
      name: 'Altair',
      coordinates: CelestialCoordinate(ra: 297.696, dec: 8.8683),
      magnitude: 0.77,
      spectralType: 'A7V',
      constellation: 'AQL',
    ),
    const Star(
      id: 'HIP60718',
      name: 'Acrux',
      coordinates: CelestialCoordinate(ra: 186.650, dec: -63.0990),
      magnitude: 0.76,
      spectralType: 'B0.5IV',
      constellation: 'CRU',
    ),
    const Star(
      id: 'HIP21421',
      name: 'Aldebaran',
      coordinates: CelestialCoordinate(ra: 68.982, dec: 16.5093),
      magnitude: 0.85,
      spectralType: 'K5III',
      constellation: 'TAU',
    ),
    const Star(
      id: 'HIP80763',
      name: 'Antares',
      coordinates: CelestialCoordinate(ra: 247.352, dec: -26.4320),
      magnitude: 1.06,
      spectralType: 'M1.5Ib',
      constellation: 'SCO',
    ),
    const Star(
      id: 'HIP65474',
      name: 'Spica',
      coordinates: CelestialCoordinate(ra: 201.298, dec: -11.1614),
      magnitude: 0.97,
      spectralType: 'B1V',
      constellation: 'VIR',
    ),
    const Star(
      id: 'HIP37826',
      name: 'Pollux',
      coordinates: CelestialCoordinate(ra: 116.330, dec: 28.0262),
      magnitude: 1.14,
      spectralType: 'K0III',
      constellation: 'GEM',
    ),
    const Star(
      id: 'HIP102098',
      name: 'Fomalhaut',
      coordinates: CelestialCoordinate(ra: 344.412, dec: -29.6223),
      magnitude: 1.16,
      spectralType: 'A3V',
      constellation: 'PSA',
    ),
    const Star(
      id: 'HIP102488',
      name: 'Deneb',
      coordinates: CelestialCoordinate(ra: 310.358, dec: 45.2803),
      magnitude: 1.25,
      spectralType: 'A2Ia',
      constellation: 'CYG',
    ),
    const Star(
      id: 'HIP62434',
      name: 'Mimosa',
      coordinates: CelestialCoordinate(ra: 191.930, dec: -59.6888),
      magnitude: 1.25,
      spectralType: 'B0.5IV',
      constellation: 'CRU',
    ),
    const Star(
      id: 'HIP54061',
      name: 'Regulus',
      coordinates: CelestialCoordinate(ra: 152.093, dec: 11.9672),
      magnitude: 1.40,
      spectralType: 'B8IV',
      constellation: 'LEO',
    ),
    const Star(
      id: 'HIP31592',
      name: 'Adhara',
      coordinates: CelestialCoordinate(ra: 104.656, dec: -28.9722),
      magnitude: 1.50,
      spectralType: 'B2II',
      constellation: 'CMA',
    ),
    const Star(
      id: 'HIP36850',
      name: 'Castor',
      coordinates: CelestialCoordinate(ra: 113.650, dec: 31.8884),
      magnitude: 1.58,
      spectralType: 'A1V',
      constellation: 'GEM',
    ),
    const Star(
      id: 'HIP78820',
      name: 'Shaula',
      coordinates: CelestialCoordinate(ra: 263.402, dec: -37.1038),
      magnitude: 1.63,
      spectralType: 'B2IV',
      constellation: 'SCO',
    ),
    const Star(
      id: 'HIP63003',
      name: 'Gacrux',
      coordinates: CelestialCoordinate(ra: 187.791, dec: -57.1132),
      magnitude: 1.64,
    ...
    const Star(
      id: 'HIP41037',
      name: 'Miaplacidus',
      coordinates: CelestialCoordinate(ra: 138.300, dec: -69.7172),
      magnitude: 1.68,
      spectralType: 'A1III',
      constellation: 'CAR',
    ),
    const Star(
      id: 'HIP25336',
      name: 'Bellatrix',
      coordinates: CelestialCoordinate(ra: 81.282, dec: 6.3497),
      magnitude: 1.64,
      spectralType: 'B2III',
      constellation: 'ORI',
    ),
    const Star(
      id: 'HIP27366',
      name: 'Elnath',
      coordinates: CelestialCoordinate(ra: 81.573, dec: 28.6074),
      magnitude: 1.65,
      spectralType: 'B7III',
      constellation: 'TAU',
    ),
    const Star(
      id: 'HIP26311',
      name: 'Alnilam',
      coordinates: CelestialCoordinate(ra: 84.054, dec: -1.2019),
      magnitude: 1.70,
      spectralType: 'B0Ia',
      constellation: 'ORI',
    ),
    ...
    const Star(
      id: 'HIP11767',
      name: 'Polaris',
      coordinates: CelestialCoordinate(ra: 37.953, dec: 89.2641),
      magnitude: 1.98,
      spectralType: 'F7Ib',
      constellation: 'UMI',
    ),
    const Star(
      id: 'HIP26727',
      name: 'Alnitak',
      coordinates: CelestialCoordinate(ra: 85.190, dec: -1.9426),
      magnitude: 1.77,
      spectralType: 'O9.7Ib',
      constellation: 'ORI',
    ),
    const Star(
      id: 'HIP15863',
      name: 'Mirfak',
      coordinates: CelestialCoordinate(ra: 51.081, dec: 49.8612),
      magnitude: 1.79,
      spectralType: 'F5Ib',
      constellation: 'PER',
    ),
    const Star(
      id: 'HIP59774',
      name: 'Dubhe',
      coordinates: CelestialCoordinate(ra: 165.932, dec: 61.7510),
      magnitude: 1.79,
      spectralType: 'K0III',
      constellation: 'UMA',
    ),
    const Star(
      id: 'HIP90185',
      name: 'Kaus Australis',
      coordinates: CelestialCoordinate(ra: 276.044, dec: -34.3847),
      magnitude: 1.80,
    ...
    const Star(
      id: 'HIP65378',
      name: 'Alioth',
      coordinates: CelestialCoordinate(ra: 193.506, dec: 55.9598),
      magnitude: 1.77,
      spectralType: 'A0p',
      constellation: 'UMA',
    ),
    const Star(
      id: 'HIP62956',
      name: 'Alkaid',
      coordinates: CelestialCoordinate(ra: 206.885, dec: 49.3133),
      magnitude: 1.86,
      spectralType: 'B3V',
      constellation: 'UMA',
    ),
    const Star(
      id: 'HIP31681',
      name: 'Alhena',
      coordinates: CelestialCoordinate(ra: 99.428, dec: 16.3993),
      magnitude: 1.93,
      spectralType: 'A0IV',
      constellation: 'GEM',
    ),
    const Star(
      id: 'HIP82273',
      name: 'Atria',
      coordinates: CelestialCoordinate(ra: 252.164, dec: -69.0277),
      magnitude: 1.92,
      spectralType: 'K2IIb',
      constellation: 'TRA',
    ),
    const Star(
      id: 'HIP46390',
      name: 'Alphard',
      coordinates: CelestialCoordinate(ra: 141.896, dec: -8.6586),
      magnitude: 1.98,
      spectralType: 'K3III',
      constellation: 'HYA',
    ),
    const Star(
      id: 'HIP9884',
      name: 'Hamal',
      coordinates: CelestialCoordinate(ra: 31.794, dec: 23.4624),
      magnitude: 2.00,
      spectralType: 'K2III',
      constellation: 'ARI',
    ),
    const Star(
      id: 'HIP14135',
      name: 'Diphda',
      coordinates: CelestialCoordinate(ra: 10.898, dec: -17.9866),
      magnitude: 2.02,
      spectralType: 'K0III',
      constellation: 'CET',
    ),
    const Star(
      id: 'HIP89931',
      name: 'Nunki',
      coordinates: CelestialCoordinate(ra: 283.816, dec: -26.2967),
      magnitude: 2.02,
      spectralType: 'B2.5V',
      constellation: 'SGR',
    ),
    const Star(
      id: 'HIP677',
      name: 'Alpheratz',
      coordinates: CelestialCoordinate(ra: 2.097, dec: 29.0904),
      magnitude: 2.06,
      spectralType: 'B9p',
      constellation: 'AND',
    ),
    const Star(
      id: 'HIP1067',
      name: 'Mirach',
      coordinates: CelestialCoordinate(ra: 17.432, dec: 35.6206),
      magnitude: 2.06,
      spectralType: 'M0III',
      constellation: 'AND',
    ),
    const Star(
      id: 'HIP86032',
      name: 'Rasalhague',
      coordinates: CelestialCoordinate(ra: 263.735, dec: 12.5600),
      magnitude: 2.07,
      spectralType: 'A5III',
      constellation: 'OPH',
    ),
    const Star(
      id: 'HIP14576',
      name: 'Algol',
      coordinates: CelestialCoordinate(ra: 47.046, dec: 40.9557),
      magnitude: 2.12,
      spectralType: 'B8V',
      constellation: 'PER',
    ),
    const Star(
      id: 'HIP49669',
      name: 'Denebola',
      coordinates: CelestialCoordinate(ra: 177.266, dec: 14.5720),
      magnitude: 2.13,
      spectralType: 'A3V',
      constellation: 'LEO',
    ),
    const Star(
      id: 'HIP44816',
      name: 'Suhail',
      coordinates: CelestialCoordinate(ra: 137.000, dec: -43.4326),
      magnitude: 2.21,
      spectralType: 'K4Ib',
      constellation: 'VEL',
    ),
    const Star(
      id: 'HIP3419',
      name: 'Schedar',
      coordinates: CelestialCoordinate(ra: 10.128, dec: 56.5373),
      magnitude: 2.23,
      spectralType: 'K0II',
      constellation: 'CAS',
    ),
    const Star(
      id: 'HIP76267',
      name: 'Alphecca',
      coordinates: CelestialCoordinate(ra: 233.673, dec: 26.7147),
      magnitude: 2.23,
      spectralType: 'A0V',
      constellation: 'CRB',
    ),
    const Star(
      id: 'HIP87833',
      name: 'Eltanin',
      coordinates: CelestialCoordinate(ra: 269.150, dec: 51.4889),
      magnitude: 2.23,
      spectralType: 'K5III',
      constellation: 'DRA',
    ),
    const Star(
      id: 'HIP25930',
      name: 'Mintaka',
      coordinates: CelestialCoordinate(ra: 83.002, dec: -0.2991),
      magnitude: 2.23,
      spectralType: 'O9.5II',
      constellation: 'ORI',
    ),
    const Star(
      id: 'HIP5447',
      name: 'Almach',
      coordinates: CelestialCoordinate(ra: 30.975, dec: 42.3297),
      magnitude: 2.26,
      spectralType: 'K3II',
      constellation: 'AND',
    ),
    const Star(
      id: 'HIP39757',
      name: 'Naos',
      coordinates: CelestialCoordinate(ra: 120.891, dec: -40.0033),
      magnitude: 2.25,
      spectralType: 'O5If',
      constellation: 'PUP',
    ),
    const Star(
      id: 'HIP67301',
      name: 'Mizar',
      coordinates: CelestialCoordinate(ra: 200.982, dec: 54.9254),
      magnitude: 2.27,
      spectralType: 'A1V',
      constellation: 'UMA',
    ),
    const Star(
      id: 'HIP4427',
      name: 'Caph',
      coordinates: CelestialCoordinate(ra: 2.295, dec: 59.1498),
      magnitude: 2.27,
      spectralType: 'F2III',
      constellation: 'CAS',
    ),
    const Star(
      id: 'HIP53910',
      name: 'Merak',
      coordinates: CelestialCoordinate(ra: 165.459, dec: 56.3824),
      magnitude: 2.37,
      spectralType: 'A1V',
      constellation: 'UMA',
    ),
    const Star(
      id: 'HIP113368',
      name: 'Scheat',
      coordinates: CelestialCoordinate(ra: 345.944, dec: 28.0828),
      magnitude: 2.42,
      spectralType: 'M2.5II',
      constellation: 'PEG',
    ),
    const Star(
      id: 'HIP58001',
      name: 'Phecda',
      coordinates: CelestialCoordinate(ra: 178.452, dec: 53.6948),
      magnitude: 2.44,
      spectralType: 'A0V',
      constellation: 'UMA',
    ),
    const Star(
      id: 'HIP105199',
      name: 'Alderamin',
      coordinates: CelestialCoordinate(ra: 319.644, dec: 62.5856),
      magnitude: 2.44,
      spectralType: 'A7IV',
      constellation: 'CEP',
    ),
    const Star(
      id: 'HIP8886',
      name: 'Navi',
      coordinates: CelestialCoordinate(ra: 14.180, dec: 60.7167),
      magnitude: 2.47,
      spectralType: 'B0IV',
      constellation: 'CAS',
    ),
    const Star(
      id: 'HIP113881',
      name: 'Markab',
      coordinates: CelestialCoordinate(ra: 346.197, dec: 15.2053),
      magnitude: 2.49,
      spectralType: 'A0IV',
      constellation: 'PEG',
    ),
    const Star(
      id: 'HIP8645',
      name: 'Menkar',
      coordinates: CelestialCoordinate(ra: 45.573, dec: 4.0897),
      magnitude: 2.53,
    ...
    const Star(
      id: 'HIP88635',
      name: 'Ascella',
      coordinates: CelestialCoordinate(ra: 285.656, dec: -29.8801),
      magnitude: 2.59,
      spectralType: 'A2IV',
      constellation: 'SGR',
    ),
    const Star(
      id: 'HIP61084',
      name: 'Gienah',
      coordinates: CelestialCoordinate(ra: 183.951, dec: -17.5419),
      magnitude: 2.59,
      spectralType: 'B8III',
      constellation: 'CRV',
    ),
    const Star(
      id: 'HIP8903',
      name: 'Sheratan',
      coordinates: CelestialCoordinate(ra: 28.659, dec: 20.8080),
      magnitude: 2.64,
      spectralType: 'A5V',
      constellation: 'ARI',
    ),
    const Star(
      id: 'HIP77070',
      name: 'Unukalhai',
      coordinates: CelestialCoordinate(ra: 236.065, dec: 6.4256),
      magnitude: 2.65,
      spectralType: 'K2III',
      constellation: 'SER',
    ),
    const Star(
      id: 'HIP746',
      name: 'Ruchbah',
      coordinates: CelestialCoordinate(ra: 21.459, dec: 60.2352),
      magnitude: 2.68,
      spectralType: 'A5IV',
      constellation: 'CAS',
    ),
    const Star(
      id: 'HIP59747',
      name: 'Imai',
      coordinates: CelestialCoordinate(ra: 183.786, dec: -58.7489),
      magnitude: 2.77,
      spectralType: 'B2IV',
      constellation: 'CRU',
    ),
    const Star(
      id: 'HIP84345',
      name: 'Kornephoros',
      coordinates: CelestialCoordinate(ra: 247.557, dec: 21.4897),
      magnitude: 2.77,
      spectralType: 'G7IIIa',
      constellation: 'HER',
    ),
    const Star(
      id: 'HIP83207',
      name: 'Rasalgethi',
      coordinates: CelestialCoordinate(ra: 258.662, dec: 14.3902),
      magnitude: 2.81,
      spectralType: 'M5Ib',
      constellation: 'HER',
    ),
    const Star(
      id: 'HIP112158',
      name: 'Algenib',
      coordinates: CelestialCoordinate(ra: 3.302, dec: 15.1836),
      magnitude: 2.83,
      spectralType: 'B2IV',
      constellation: 'PEG',
    ),
    const Star(
      id: 'HIP109074',
      name: 'Sadalsuud',
      coordinates: CelestialCoordinate(ra: 322.890, dec: -5.5712),
      magnitude: 2.91,
      spectralType: 'G0Ib',
      constellation: 'AQR',
    ),
    const Star(
      id: 'HIP109139',
      name: 'Sadalmelik',
      coordinates: CelestialCoordinate(ra: 331.446, dec: -0.3199),
      magnitude: 2.96,
      spectralType: 'G2Ib',
      constellation: 'AQR',
    ),
    const Star(
      id: 'HIP10826',
      name: 'Mira',
      coordinates: CelestialCoordinate(ra: 34.838, dec: -2.9776),
      magnitude: 3.04,
      spectralType: 'M7IIIe',
      constellation: 'CET',
    ),
    const Star(
      id: 'HIP107315',
      name: 'Albireo',
      coordinates: CelestialCoordinate(ra: 292.680, dec: 27.9597),
      magnitude: 3.18,
      spectralType: 'K3II',
      constellation: 'CYG',
    ),
    const Star(
      id: 'HIP59774',
      name: 'Megrez',
      coordinates: CelestialCoordinate(ra: 183.857, dec: 57.0326),
      magnitude: 3.31,
      spectralType: 'A3V',
      constellation: 'UMA',
    ),
    const Star(
      id: 'HIP6686',
      name: 'Segin',
      coordinates: CelestialCoordinate(ra: 28.598, dec: 63.6700),
      magnitude: 3.37,
      spectralType: 'B3III',
      constellation: 'CAS',
    ),
    const Star(
      id: 'HIP9487',
      name: 'Eta Piscium',
      coordinates: CelestialCoordinate(ra: 22.880, dec: 15.3458),
      magnitude: 3.62,
      spectralType: 'G7III',
      constellation: 'PSC',
    ),
