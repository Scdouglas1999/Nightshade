// Regression: the Catalog Settings "Depth" chip is the surface the audit
// actually read — "119.6k objects, 32.4 MB, Version 4.2, Package Complete,
// Depth mag <= 15.0" beside a green "Installed" badge. 15.0 is the HYG
// loader's inclusion filter, not the catalog's completeness; presented as
// "Depth" next to "Package: Complete" it told the user the nearly-empty field
// at an imaging FOV was the real sky.
//
...
// hard-coded string in card_builders.dart would keep that test green. This
// test renders the real screen over a real installed-catalog fixture and reads
// the chip.
import 'dart:convert';
import 'dart:io';
