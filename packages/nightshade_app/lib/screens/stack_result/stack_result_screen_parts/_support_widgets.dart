...
/// Export/share actions, all of them surfaced through the header's single
/// overflow menu (05 §5: a page header carries at most two actions, and the
/// other one here is "Refine in Darkroom").
