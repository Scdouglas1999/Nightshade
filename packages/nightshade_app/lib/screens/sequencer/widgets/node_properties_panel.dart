...
/// P3-8: explicit fallback for node types not in the dispatch switch.
///
/// The old `else` branch silently displayed "No additional properties",
/// which was indistinguishable from "this node legitimately has nothing to
/// configure". That hid real bugs (e.g. StartGuidingNode falling through
/// even though it has settle parameters). This widget surfaces the dispatch
/// miss so it gets caught during development instead of leaving the user
