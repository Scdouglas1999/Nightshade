...
class _FirstNightWizardLauncherState
  ...
  // Owned so we can cancel on dispose — otherwise a teardown mid-delay
  // (hot reload, widget-test) leaks a pending Timer past the widget tree.
  Timer? _deferTimer;
  ...
  void _scheduleCheck() {
    ...
    _deferTimer = Timer(const Duration(milliseconds: 1500), _maybeShow);
  }
