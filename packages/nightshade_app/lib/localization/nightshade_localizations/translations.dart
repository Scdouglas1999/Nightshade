...
final Map<String, Map<String, String>> _localizedValues = {
  'en': {
    ...
    // The rail destinations. Nouns for places, not descriptions of them:
    // the rail carries a label and nothing else, so the label has to be the
    // whole answer.
    'navTonight': 'Tonight',
    ...
    'dbWidgets': 'Widgets',
    'dbReset': 'Reset',
    // Observatory wave 3 — Tonight (/dashboard), 06 §Tonight.
    'tnEditLayout': 'Edit layout',
    'tnEditModeTitle': 'Edit layout',
    'tnStateRunning': 'Running',
    'tnStatePaused': 'Paused',
    'tnStateSequenceReady': 'Sequence ready',
    'tnStateNothingRunning': 'Nothing running',
    'tnHeadlineClearAfter': 'Clear skies after {time}',
    'tnHeadlineNoSite': 'Set your observing site to plan tonight',
    'tnNodeCount': '{count} nodes',
    'tnDarkIn': 'Astronomical dark in {duration}',
    'tnDarkWindow': 'Astronomical dark {start} – {end} · {duration}',
    'tnMoonSets': 'Moon {percent}%, sets {time}',
    'tnMoonOnly': 'Moon {percent}%',
    'tnOpenInSequencer': 'Open in Sequencer',
    'tnStartSequence': 'Start sequence',
    'tnPlanTarget': 'Plan a target',
    'tnConnectEquipment': 'Connect equipment',
    'tnBuildSequence': 'Build a sequence',
    'tnPause': 'Pause',
    'tnResume': 'Resume',
    'tnStop': 'Stop',
    'tnHoldToStop': 'Hold to stop',
    'tnHoldToStopHint': 'Press and hold to stop the sequence',
    'tnChecklistTitle': 'Ready for first light',
    'tnChecklistProgress': '{done} of {total} done',
    'tnStepSite': 'Set your observing site',
    'tnStepSiteDetail':
        'Enter your latitude and longitude so targets, slews and the night '
            'band are computed for where you are.',
    'tnStepSiteAction': 'Set site',
    'tnStepFolder': 'Choose a capture folder',
    'tnStepFolderDetail': 'Pick where new frames are written.',
    'tnStepFolderAction': 'Choose',
    'tnStepDevices': 'Connect your camera and mount',
    'tnStepDevicesDetail':
        'Scan for ASCOM, INDI, Alpaca and native devices, then save them as a '
            'profile.',
    'tnStepDevicesAction': 'Connect',
    'tnStepCatalogs': 'Install the star and object catalogs',
    'tnStepCatalogsDetail':
        'HYG stars + OpenNGC, about 60 MB. Powers the planetarium, plate '
            'solving and annotations.',
    'tnStepCatalogsAction': 'Download',
    'tnStepSolver': 'Set up a plate solver',
    'tnStepSolverDetail':
        'ASTAP or astrometry.net, needed for centering and framing.',
    'tnStepSolverAction': 'Set up',
    'tnNoFramesTitle': 'No frames yet',
    'tnNoFramesBody': 'Frames appear here as the sequence captures them',
    'tnLastSub': 'Last sub {time} · {filter} · {exposure}',
    'tnHfr': 'HFR',
    'tnEcc': 'Ecc',
    'tnStars': 'Stars',
    'tnRms': 'RMS',
    'tnEquipment': 'Equipment',
    'tnAllConnected': 'All connected',
    'tnSomeConnected': '{count} of {total} connected',
    'tnNotConnected': 'Not connected',
    'tnCamera': 'Camera',
    'tnMount': 'Mount',
    'tnFocuser': 'Focuser',
    'tnFilterWheel': 'Filter wheel',
    'tnGuider': 'Guider',
    'tnSensor': 'Sensor',
    'tnCooler': 'Cooler',
    'tnRa': 'RA',
    ...
    'tnTemp': 'Temp',
    'tnFilter': 'Filter',
    'tnTotalRms': 'Total RMS',
    'tnGuiding': 'Guiding',
    'tnIdle': 'Idle',
    'tnDisconnected': 'Disconnected',
    'tnNoGuideData': 'No guide data yet',
    'tnConnectGuider': 'Connect a guider to see corrections',
    'tnRaRms': 'RA rms',
    'tnDecRms': 'Dec rms',
    'tnTotal': 'Total',
    'tnSnr': 'SNR',
    'tnProgress': 'Progress',
    'tnEndsAt': 'ends ~{time}',
    'tnNoFilterPlan': 'No per-filter plan in the loaded sequence',
    'tnIntegrated': 'Integrated',
    'tnRemaining': 'Remaining',
    'tnRejected': 'Rejected',
    'tnSafetyEvents': 'Safety & events',
    'tnSafe': 'Safe',
    'tnUnsafe': 'Unsafe',
    'tnSnoozed': 'Snoozed',
    'tnNotMonitored': 'Not monitored',
    'tnMonitored': 'Monitored',
    'tnNoWeatherData': 'No data',
    'tnClouds': 'Clouds',
    'tnWind': 'Wind',
    'tnDewPoint': 'Dew point',
    'tnMargin': 'margin',
    'tnNoEvents': 'No events yet tonight',
    'tnMoon': 'Moon',
    'tnIlluminated': 'Illuminated',
    'tnMoonset': 'Moonset',
    'tnMoonrise': 'Moonrise',
    'tnWeather': 'Weather',
    'tnWeatherOnBody':
        'Weather safety is on. The mount parks automatically when clouds or '
            'wind exceed your limits.',
    'tnWeatherOffBody':
        'Turn on weather safety to park the mount automatically when clouds '
            'or wind exceed your limits.',
    'tnOpenWeather': 'Open weather',
    'tnLastNight': 'Last night',
    'tnLastRun': 'Last run',
    'tnNoRunsYet':
        'No runs yet. Your first night’s report will appear here in the '
            'morning.',
    'tnStarted': 'Started',
    'tnOutcome': 'Outcome',
    'tnLayoutErrorTitle': 'The dashboard layout could not be read',
    'dbEditModeHint':
    ...
    'dbTonight': 'Tonight',
    // Observatory wave 3 — Plan screen.
    'plannerTitleShort': 'Plan',
    'plannerTabTonight': 'Tonight',
    'plannerTabYourSky': 'Your sky',
    'plannerChipMoon': 'Moon {value}%',
    'plannerChipDark': 'Dark {start} – {end}',
    'plannerChipDarkNone': 'No astronomical dark',
    'plannerSearchHint': 'Search targets and catalogs',
    'plannerSortPrefix': 'Sort:',
    'plannerColTransit': 'Transit',
    ...
    'plannerAltNow': 'Alt now',
    'plannerFromMoon': 'From moon',
    'plannerWindow': 'Window',
    'plannerFrameIt': 'Frame it',
    'plannerBuildSequence': 'Build sequence',
    'plannerKvFramesOnDisk': 'Frames on disk',
    'plannerKvObjectType': 'Object type',
    'plannerKvConstellation': 'Constellation',
    'plannerKvMagnitude': 'Magnitude',
    'plannerKvSize': 'Size',
    ...
    'plannerNoMatchesBody':
        '{total} candidates were scored and {passed} passed the filters.',
    'plannerNoMatchesAction': 'Reset filters',
    'plannerPlanFailedAction': 'Retry',
    'plannerSelectCandidateTitle': 'Pick a target',
  ...
  'es': {
    ...
    'navWeather': 'Clima',
    'navPlan': 'Plan',
    // TODO(l10n): English copy, awaiting a Spanish term for the review room.
    'navDarkroom': 'Darkroom',
    ...
    'dbWidgets': 'Widgets',
    'dbReset': 'Restablecer',
    // TODO(l10n): Observatory wave 3 — Tonight (/dashboard). English copy pending translation.
    'tnEditLayout': 'Edit layout',
    'tnEditModeTitle': 'Edit layout',
    'tnStateRunning': 'Running',
    'tnStatePaused': 'Paused',
    ...
    // Observatory wave 3 — Plan screen.
    'plannerTitleShort': 'Planificar',
    'plannerTabTonight': 'Esta noche',
    'plannerTabYourSky': 'Tu cielo',
    'plannerChipMoon': 'Luna {value} %',
    'plannerChipDark': 'Oscuridad {start} – {end}',
    'plannerChipDarkNone': 'Sin noche astronómica',
    'plannerSearchHint': 'Buscar objetivos y catálogos',
    'plannerSortPrefix': 'Orden:',
    'plannerColTransit': 'Tránsito',
    ...
    'plannerAltNow': 'Altura ahora',
    'plannerFromMoon': 'De la luna',
    'plannerWindow': 'Ventana',
    'plannerFrameIt': 'Encuadrar',
    'plannerBuildSequence': 'Crear secuencia',
    'plannerKvFramesOnDisk': 'Tomas en disco',
    'plannerKvObjectType': 'Tipo de objeto',
    'plannerKvConstellation': 'Constelación',
    'plannerKvMagnitude': 'Magnitud',
    ...
    'plannerNoMatchesBody':
        'Se puntuaron {total} candidatos y {passed} pasaron los filtros.',
    'plannerNoMatchesAction': 'Restablecer filtros',
    'plannerPlanFailedAction': 'Reintentar',
    'plannerSelectCandidateTitle': 'Elige un objetivo',
    'plannerSelectCandidateBody':
