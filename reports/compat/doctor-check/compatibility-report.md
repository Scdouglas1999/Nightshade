...
- Generated: 2026-05-13T17:47:21.7535302Z
- Platform: `windows`
- Targets: 17 pass, 0 fail, 5 blocked, 1 skipped
- Functions: 81 pass, 0 fail, 0 blocked
...
| pass | `zwo-fake-sdk-contract` | ZWO | Camera,Focuser,FilterWheel | Native SDK | Production driver + fake SDK shims | declared runtime/API prerequisites are present |
...
| pass | `qhy-fake-sdk-contract` | QHYCCD | Camera,FilterWheel | Native SDK | Production driver + fake SDK shim | declared runtime/API prerequisites are present |
| pass | `playerone-native-camera` | Player One | Camera | Native SDK | SDK runtime | declared runtime/API prerequisites are present |
| pass | `playerone-fake-sdk-contract` | Player One | Camera | Native SDK | Production driver + fake SDK shim | declared runtime/API prerequisites are present |
...
| pass | `svbony-fake-sdk-contract` | SVBONY | Camera | Native SDK | Production driver + fake SDK shim | declared runtime/API prerequisites are present |
| pass | `atik-native-camera` | Atik | Camera,FilterWheel | Native SDK | SDK runtime | declared runtime/API prerequisites are present |
| pass | `atik-fake-sdk-contract` | Atik | Camera | Native SDK | Production driver + fake SDK shim | declared runtime/API prerequisites are present |
