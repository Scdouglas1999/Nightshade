...
- Generated: 2026-05-13T02:14:12.1008295Z
- Platform: `windows`
- Targets: 12 pass, 0 fail, 5 blocked, 1 skipped
- Functions: 59 pass, 0 fail, 0 blocked
- Models: 43 pass, 0 fail, 13 blocked

## Targets
| Verdict | Target | Manufacturer | Device | Driver | Tier | Reason |
|---|---|---|---|---|---|---|
| pass | `zwo-native-camera-eaf-efw` | ZWO | Camera,Focuser,FilterWheel | Native SDK | SDK runtime + Nightshade tests | declared runtime/API prerequisites are present |
| pass | `qhy-native-camera-cfw` | QHYCCD | Camera,FilterWheel | Native SDK | SDK runtime + Nightshade tests | declared runtime/API prerequisites are present |
| pass | `playerone-native-camera` | Player One | Camera | Native SDK | SDK runtime | declared runtime/API prerequisites are present |
| pass | `svbony-native-camera` | SVBONY | Camera | Native SDK | SDK runtime + Nightshade tests | declared runtime/API prerequisites are present |
| pass | `atik-native-camera` | Atik | Camera,FilterWheel | Native SDK | SDK runtime | declared runtime/API prerequisites are present |
| pass | `fli-native-camera-focuser-filterwheel` | Finger Lakes Instrumentation | Camera,Focuser,FilterWheel | Native SDK | SDK source evidence | declared runtime/API prerequisites are present |
| pass | `touptek-native-white-labels` | ToupTek/OGMA/Altair | Camera | Native SDK | SDK runtime | declared runtime/API prerequisites are present |
| pass | `moravian-native-camera-filterwheel` | Moravian | Camera,FilterWheel | Native SDK | SDK runtime | declared runtime/API prerequisites are present |
| pass | `fujifilm-native-camera` | Fujifilm | Camera | Native SDK | SDK runtime | declared runtime/API prerequisites are present |
| pass | `alpaca-simulator-contract` | ASCOM Initiative | Camera,FilterWheel,Mount | ASCOM Alpaca | Local protocol simulator | declared runtime/API prerequisites are present |
| pass | `mount-protocol-source-contracts` | Sky-Watcher/iOptron/LX200-compatible | Mount | Native Serial/UDP | Protocol parser/command tests | declared runtime/API prerequisites are present |
| pass | `bridge-full-workspace` | Nightshade | All | Bridge | Workspace tests | declared runtime/API prerequisites are present |
...
|---|---|---|---|---|---|---|
| pass | ZWO | ASI2600MM Pro | Camera | ASI cooled APS-C mono | sdk-family | declared capabilities map to passing function evidence |
| pass | ZWO | ASI2600MC Pro | Camera | ASI cooled APS-C color | sdk-family | declared capabilities map to passing function evidence |
| pass | ZWO | ASI533MM Pro | Camera | ASI cooled square mono | sdk-family | declared capabilities map to passing function evidence |
| pass | ZWO | ASI533MC Pro | Camera | ASI cooled square color | sdk-family | declared capabilities map to passing function evidence |
| pass | ZWO | ASI6200MM Pro | Camera | ASI cooled full-frame mono | sdk-family | declared capabilities map to passing function evidence |
| pass | ZWO | ASI120MM Mini | Camera | ASI guide camera | sdk-family | declared capabilities map to passing function evidence |
| pass | ZWO | EAF 5V | Focuser | ZWO EAF | sdk-family | declared capabilities map to passing function evidence |
| pass | ZWO | EFW 7x36mm | FilterWheel | ZWO EFW | sdk-family | declared capabilities map to passing function evidence |
| pass | QHYCCD | QHY268M | Camera | QHY cooled APS-C mono | sdk-family | declared capabilities map to passing function evidence |
| pass | QHYCCD | QHY268C | Camera | QHY cooled APS-C color | sdk-family | declared capabilities map to passing function evidence |
| pass | QHYCCD | QHY600M | Camera | QHY cooled full-frame mono | sdk-family | declared capabilities map to passing function evidence |
| pass | QHYCCD | QHY5III462C | Camera | QHY planetary/guide | sdk-family | declared capabilities map to passing function evidence |
| pass | QHYCCD | QHYCFW3 | FilterWheel | QHY CFW | sdk-family | declared capabilities map to passing function evidence |
| pass | Player One | Poseidon-M Pro | Camera | Player One cooled mono | sdk-family | declared capabilities map to passing function evidence |
| pass | Player One | Poseidon-C Pro | Camera | Player One cooled color | sdk-family | declared capabilities map to passing function evidence |
| pass | Player One | Uranus-C Pro | Camera | Player One cooled planetary | sdk-family | declared capabilities map to passing function evidence |
| pass | Player One | Neptune-C II | Camera | Player One planetary | sdk-family | declared capabilities map to passing function evidence |
| pass | SVBONY | SV405CC | Camera | SVBONY cooled color | sdk-family | declared capabilities map to passing function evidence |
| pass | SVBONY | SV605CC | Camera | SVBONY cooled color | sdk-family | declared capabilities map to passing function evidence |
| pass | SVBONY | SV305 Pro | Camera | SVBONY planetary/guide | sdk-family | declared capabilities map to passing function evidence |
| pass | Atik | Atik 460EX | Camera | Atik CCD | sdk-family | declared capabilities map to passing function evidence |
| pass | Atik | Atik Horizon II | Camera | Atik CMOS | sdk-family | declared capabilities map to passing function evidence |
| pass | Atik | Atik EFW2 | FilterWheel | Atik EFW | sdk-family | declared capabilities map to passing function evidence |
| pass | ToupTek/OGMA | OGMA AP26CC | Camera | ToupTek/OGMA cooled color | sdk-family | declared capabilities map to passing function evidence |
| pass | ToupTek/OGMA | ToupTek ATR3CMOS26000KPA | Camera | ToupTek cooled APS-C color | sdk-family | declared capabilities map to passing function evidence |
| pass | Altair | Hypercam 26C | Camera | ToupTek white-label | sdk-family | declared capabilities map to passing function evidence |
| pass | Moravian | C3-26000 | Camera | Moravian C3 CMOS | sdk-family | declared capabilities map to passing function evidence |
| pass | Moravian | C4-16000 | Camera | Moravian C4 CCD | sdk-family | declared capabilities map to passing function evidence |
| pass | Moravian | SFW | FilterWheel | Moravian filter wheel | sdk-family | declared capabilities map to passing function evidence |
| pass | Fujifilm | GFX100 II | Camera | Fujifilm GFX | sdk-header | declared capabilities map to passing function evidence |
| pass | Fujifilm | GFX100S II | Camera | Fujifilm GFX | sdk-header | declared capabilities map to passing function evidence |
| pass | Fujifilm | X-H2 | Camera | Fujifilm X | sdk-header | declared capabilities map to passing function evidence |
| pass | Fujifilm | X-H2S | Camera | Fujifilm X | sdk-header | declared capabilities map to passing function evidence |
| pass | Fujifilm | X-T5 | Camera | Fujifilm X | sdk-header | declared capabilities map to passing function evidence |
| pass | ASCOM Initiative | Alpaca Camera Simulator | Camera | Alpaca v1 | local-simulator | declared capabilities map to passing function evidence |
| pass | ASCOM Initiative | Alpaca Telescope Simulator | Mount | Alpaca v1 | local-simulator | declared capabilities map to passing function evidence |
| pass | ASCOM Initiative | Alpaca FilterWheel Simulator | FilterWheel | Alpaca v1 | local-simulator | declared capabilities map to passing function evidence |
| pass | Sky-Watcher | EQ6-R Pro | Mount | SynScan/EQMOD | protocol-contract | declared capabilities map to passing function evidence |
| pass | Sky-Watcher | HEQ5 Pro | Mount | SynScan/EQMOD | protocol-contract | declared capabilities map to passing function evidence |
| pass | iOptron | CEM70 | Mount | iOptron serial | protocol-contract | declared capabilities map to passing function evidence |
| pass | iOptron | GEM45 | Mount | iOptron serial | protocol-contract | declared capabilities map to passing function evidence |
| pass | Meade/OnStep/etc. | OnStep | Mount | LX200-compatible | protocol-contract | declared capabilities map to passing function evidence |
| pass | Meade | LX200 | Mount | LX200-compatible | protocol-contract | declared capabilities map to passing function evidence |
| blocked | ASCOM Initiative | Omni Camera Simulator | Camera | ASCOM COM/Alpaca simulator | blocked-until-conformu | missing function evidence for: enumerate, connect, expose, download_image, controls, cooler |
| blocked | ASCOM Initiative | Omni Telescope Simulator | Mount | ASCOM COM/Alpaca simulator | blocked-until-conformu | missing function evidence for: enumerate, connect, slew, tracking, read_position |
| blocked | ASCOM Initiative | Omni FilterWheel Simulator | FilterWheel | ASCOM COM/Alpaca simulator | blocked-until-conformu | missing function evidence for: enumerate, connect, set_filter, read_filter |
| blocked | Canon | EOS Ra | Camera | Canon EOS astro DSLR/mirrorless | sdk-access-blocked | missing function evidence for: enumerate, connect, expose, download_image, controls |
| blocked | Canon | EOS R5 | Camera | Canon EOS mirrorless | sdk-access-blocked | missing function evidence for: enumerate, connect, expose, download_image, controls |
| blocked | Canon | EOS 6D Mark II | Camera | Canon EOS DSLR | sdk-access-blocked | missing function evidence for: enumerate, connect, expose, download_image, controls |
| blocked | Nikon | D810A | Camera | Nikon astro DSLR | sdk-access-blocked | missing function evidence for: enumerate, connect, expose, download_image, controls |
| blocked | Nikon | Z8 | Camera | Nikon mirrorless | sdk-access-blocked | missing function evidence for: enumerate, connect, expose, download_image, controls |
| blocked | Nikon | Z6 III | Camera | Nikon mirrorless | sdk-access-blocked | missing function evidence for: enumerate, connect, expose, download_image, controls |
| blocked | Celestron | NexStar Evolution | Mount | Celestron AUX/CPWI | native-driver-roadmap | missing function evidence for: enumerate, connect, slew, tracking, read_position |
| blocked | Celestron | CGX | Mount | Celestron AUX/CPWI | native-driver-roadmap | missing function evidence for: enumerate, connect, slew, tracking, read_position |
| blocked | Pegasus Astro | Ultimate Powerbox v3 | Switch,Power,Weather,DewControl | Pegasus Powerbox | native-driver-roadmap | missing function evidence for: enumerate, connect, controls |
| blocked | Pegasus Astro | FocusCube 3 | Focuser | Pegasus focuser | native-driver-roadmap | missing function evidence for: enumerate, connect, move_focuser, read_position |
