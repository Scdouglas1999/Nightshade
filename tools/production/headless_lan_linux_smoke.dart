...
void main(List<String> args) async {
  if (!Platform.isLinux) {
    stderr.writeln('Linux packaged headless smoke must run on Linux.');
    exit(2);
  }
  ...
  try {
    ...
    if (info.json['webUIAvailable'] != true) {
      throw StateError(
        '/api/info webUIAvailable expected true when dashboard is bundled: '
        '${info.text}',
      );
    }
