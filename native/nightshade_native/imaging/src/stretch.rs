...
pub fn apply_stretch_rgb(rgb_data: &[u16], width: u32, height: u32, params: &StretchParams) -> Vec<u8> {
    let range = params.highlights - params.shadows;
    if range <= 0.0 {
...
pub fn auto_stretch_rgb(rgb_data: &[u16], width: u32, height: u32) -> (StretchParams, StretchParams, StretchParams) {
    let pixel_count = (width * height) as usize;
    
    if rgb_data.len() != pixel_count * 3 {
        return (StretchParams::default(), StretchParams::default(), StretchParams::default());
    }
