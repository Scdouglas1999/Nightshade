...
List<HeadlessRoute> buildImagingRoutes(ImagingHandlers h) => <HeadlessRoute>[
      ...
      HeadlessRoute(
          HttpMethod.post, '/api/imaging/stretch', h.handleAutoStretchImage),
      HeadlessRoute(
          HttpMethod.get, '/api/imaging/star-crops', h.handleGetStarCrops),
      HeadlessRoute(
          HttpMethod.post, '/api/imaging/debayer', h.handleDebayerImage),
      HeadlessRoute(HttpMethod.get, '/api/imaging/raw-data',
          h.handleGetLastRawImageData),
      HeadlessRoute(
          HttpMethod.post, '/api/imaging/save-fits', h.handleSaveFitsFile),
      HeadlessRoute(HttpMethod.post, '/api/imaging/save-fits-from-capture',
          h.handleSaveFitsFromLastCapture),
      HeadlessRoute(HttpMethod.post, '/api/imaging/calibrate-file',
          h.handleCalibrateImageFile),
      HeadlessRoute(HttpMethod.delete, '/api/imaging/device-image/<deviceId>',
