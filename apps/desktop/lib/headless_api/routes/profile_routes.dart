...
List<HeadlessRoute> buildProfileRoutes(ProfileHandlers h) => <HeadlessRoute>[
      ...
      HeadlessRoute(HttpMethod.delete, '/api/profiles/<profileId>',
          h.handleDeleteProfile),
      HeadlessRoute(HttpMethod.post, '/api/profiles/<profileId>/load',
          h.handleLoadProfile),
      HeadlessRoute(
          HttpMethod.get, '/api/profiles/active', h.handleGetActiveProfile),
      ...
      HeadlessRoute(
          HttpMethod.get, '/api/settings/location', h.handleGetLocation),
      HeadlessRoute(
          HttpMethod.post, '/api/settings/location', h.handleSetLocation),
      HeadlessRoute(
          HttpMethod.get, '/api/location', h.handleGetLocationFromInternet),
    ];
