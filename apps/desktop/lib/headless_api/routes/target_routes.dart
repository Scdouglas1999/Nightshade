...
List<HeadlessRoute> buildTargetRoutes(TargetHandlers h) => <HeadlessRoute>[
  ...
  HeadlessRoute(HttpMethod.get, '/api/targets/search', h.handleSearchTargets),
  HeadlessRoute(
    HttpMethod.get,
    '/api/targets/by-type',
    h.handleGetTargetsByType,
  ),
  HeadlessRoute(
    HttpMethod.get,
    '/api/targets/by-priority',
    h.handleGetTargetsByPriority,
  ),
  HeadlessRoute(HttpMethod.get, '/api/targets/<id>', h.handleGetTargetById),
  ...
  HeadlessRoute(HttpMethod.delete, '/api/targets/<id>', h.handleDeleteTarget),
  HeadlessRoute(
    HttpMethod.post,
    '/api/targets/<id>/favorite',
