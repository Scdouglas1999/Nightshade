...
List<HeadlessRoute> buildSessionRoutes(SessionHandlers h) => <HeadlessRoute>[
      // Polar Alignment
      HeadlessRoute(HttpMethod.post, '/api/polar-alignment/start',
          h.handleStartPolarAlignment),
      HeadlessRoute(HttpMethod.post, '/api/polar-alignment/all-sky/start',
          h.handleStartAllSkyPolarAlignment),
      HeadlessRoute(HttpMethod.post, '/api/polar-alignment/stop',
          h.handleStopPolarAlignment),

      // Session Images
      HeadlessRoute(HttpMethod.get, '/api/sessions/<sessionId>/images',
      ...
      HeadlessRoute(
          HttpMethod.get, '/api/images/recent', h.handleGetRecentImages),
      HeadlessRoute(HttpMethod.get, '/api/images/standalone',
      ...
      HeadlessRoute(HttpMethod.post, '/api/images/backfill-thumbnails',
          h.handleBackfillThumbnails),
      HeadlessRoute(HttpMethod.post, '/api/images', h.handleCreateImage),
      HeadlessRoute(
          HttpMethod.get, '/api/images/<imageId>', h.handleGetImageById),
      HeadlessRoute(
          HttpMethod.put, '/api/images/<imageId>', h.handleUpdateImage),
      HeadlessRoute(HttpMethod.get, '/api/images/<imageId>/thumbnail',
          h.handleGetImageThumbnail),
      HeadlessRoute(
          HttpMethod.post,
          '/api/images/<imageId>/regenerate-thumbnail',
          h.handleRegenerateImageThumbnail),
      HeadlessRoute(HttpMethod.get, '/api/images/<imageId>/download',
          h.handleDownloadImage),
      HeadlessRoute(HttpMethod.get, '/api/sessions/<sessionId>/export/json',
          h.handleExportSessionJson),
      HeadlessRoute(HttpMethod.get, '/api/sessions/<sessionId>/export/csv',
          h.handleExportSessionCsv),
      HeadlessRoute(HttpMethod.get, '/api/sessions/<sessionId>/export/html',
