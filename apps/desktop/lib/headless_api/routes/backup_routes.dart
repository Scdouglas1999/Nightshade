...
List<HeadlessRoute> buildBackupRoutes(BackupHandlers h) => <HeadlessRoute>[
      ...
      HeadlessRoute(
          HttpMethod.post, '/api/backup/create', h.handleCreateBackup),
      HeadlessRoute(
          HttpMethod.post, '/api/backup/restore', h.handleRestoreBackup),
      HeadlessRoute(
          HttpMethod.post, '/api/backup/auto-save', h.handleAutoSaveBackup),
      HeadlessRoute(HttpMethod.post, '/api/backup/upload-restore',
          h.handleUploadRestoreBackup),
      HeadlessRoute(HttpMethod.get, '/api/backup/<id>/metadata',
          h.handleGetBackupMetadata),
      HeadlessRoute(HttpMethod.get, '/api/backup/<id>/download',
          h.handleDownloadBackup),
      HeadlessRoute(
          HttpMethod.delete, '/api/backup/<id>', h.handleDeleteBackup),
    ];
