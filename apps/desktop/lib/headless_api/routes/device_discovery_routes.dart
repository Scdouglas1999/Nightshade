...
List<HeadlessRoute> buildDeviceDiscoveryRoutes(DeviceDiscoveryHandlers h) =>
    <HeadlessRoute>[
      HeadlessRoute(HttpMethod.get, '/api/devices', h.handleGetDevices),
      HeadlessRoute(HttpMethod.get, '/api/devices/discover-indi',
          h.handleDiscoverIndiAtAddress),
      HeadlessRoute(HttpMethod.get, '/api/devices/discover-alpaca',
