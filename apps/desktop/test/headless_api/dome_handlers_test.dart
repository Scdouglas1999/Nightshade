...
void main() {
  group('DomeHandlers', () {
    ...
    test('sync missing deviceId returns JSON bad request', () async {
      final response = await translateHandlerErrors(handlers.handleDomeSync(
        Request(
          'POST',
    ...
    test('home missing deviceId returns JSON bad request', () async {
      final response = await translateHandlerErrors(handlers.handleDomeHome(
        Request(
          'POST',
    ...
    test('halt missing deviceId returns JSON bad request', () async {
      final response = await translateHandlerErrors(handlers.handleDomeHalt(
        Request(
          'POST',
